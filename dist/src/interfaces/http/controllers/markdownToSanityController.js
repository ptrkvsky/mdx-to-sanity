    ...
    if (typeof body === "object" && body !== null) {
        ...
        if ("markdown" in bodyObj && typeof bodyObj.markdown === "string") {
            return {
                ...
                frontmatter: "frontmatter" in bodyObj &&
...
export function createMarkdownToSanityController(converter, sanityClient) {
    return async (c) => {
        try {
            ...
            if (!request) {
                return c.json({
                    error: "Request body must contain either 'filePath' (string) or 'markdown' (string) with optional 'frontmatter'",
                }, 400);
            }
